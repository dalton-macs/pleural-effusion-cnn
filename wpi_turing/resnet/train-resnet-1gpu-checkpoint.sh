...
#SBATCH -n 24
#SBATCH --mem=12g
#SBATCH -J "resnet checkpoint 1gpu"
#SBATCH -p academic
#SBATCH -t 48:00:00
#SBATCH --gres=gpu:1
#SBATCH -C A100|V100
...
python src/train.py resnet --model-name "ResNet18ShowkatCustom-1GPU-Turing" --checkpoint-path "model/ResNet18ShowkatCustom/checkpoints/epoch_27_batch_233.pth"
